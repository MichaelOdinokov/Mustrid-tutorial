...
tahvel.create_line(30, 40, 300, 40) # line joonistab
...
tahvel.create_polygon(30,160,  300,160,  300,200,  60,200, fill="#95BD9D") #flag

# ristkülik
tahvel.create_rectangle(30,260,  300,300) # Eesti

# ovaal
tahvel.create_oval(30,260,  300,300, width=2, outline="blue", fill="wheat")# Muster
